 ...
 *
 */
class RoundedCornersTransformation(radius: Int, margin: Int): BitmapTransformation() {
    ...
    constructor(radius: Int, margin: Int, cornerType: CornerType?):this(radius,margin) {
        this.radius = radius
        diameter = this.radius * 2
        this.margin = margin
        this.cornerType = cornerType
